...
const course: Course = {
  ...
  "dimensions": [
    ...
    {
      "id": 2,
      "proposito": "¿Qué capacidades movilizaremos? Integramos los fundamentos de la genética molecular clásica con el dominio instrumental del ADN recombinante y herramientas de análisis inmunológico.",
    ...
    {
      "id": 3,
      "proposito": "¿Cómo evidenciamos el progreso paso a paso? Desde la descripción de los mecanismos moleculares de herencia hasta el diseño, ejecución e interpretación de técnicas bioquímicas, de ADN recombinante e inmunodiagnóstico.",
      ...
      "examples": [
        {
          ...
          "modalContent": {
            ...
            "items": [
              {
                "label": "1. Presentación y Análisis de Resultados",
                "content": "• Destacado: Presenta las imágenes del gel de agarosa debidamente rotuladas, indicando el peso de las bandas en comparación con el marcador de peso molecular y calculando correctamente los rendimientos.\n• Básico: Muestra las imágenes del gel pero carece de rotulación adecuada o no discute la presencia de bandas inespecíficas/dímeros de partidores."
              },
              {
                "label": "2. Discusión Científica y Troubleshooting",
                "content": "• Destacado: Explica con argumentos bioquímicos por qué la reacción funcionó o falló, sugiriendo optimizaciones lógicas (ej. modificar temperatura de alineamiento o concentración de MgCl2).\n• Básico: Atribuye las fallas experimentales únicamente a 'errores humanos' sin profundizar en los factores bioquímicos involucrados."
              },
              {
                "label": "3. Conclusiones y Rigor",
                "content": "• Destacado: Redacta conclusiones concisas, alineadas a los objetivos del práctico y sustentadas en datos empíricos."
              }
            ]
          }
        },
        ...
        },
        {
          ...
          "modalContent": {
            ...
            "items": [
              {
                "label": "1. Comprensión Metodológica",
                "content": "• Destacado: Explica con absoluta claridad los principios detrás de las metodologías complejas presentadas en el paper (ej. CRISPR/Cas9, secuenciación RNA-seq, ChIP-seq), justificando por qué los autores las usaron.\n• Básico: Se limita a describir los resultados de los gráficos sin comprender cómo se obtuvieron dichos datos experimentales."
              },
              {
                "label": "2. Pensamiento Crítico y Discusión",
                "content": "• Destacado: Evalúa de manera crítica si las conclusiones de los autores están respaldadas por los gráficos de resultados expuestos, sugiriendo experimentos complementarios razonables.\n• Básico: Acepta todas las afirmaciones del paper de forma dogmática sin cuestionar los controles ni el tamaño muestral."
              },
              {
                "label": "3. Habilidades Comunicativas y Defensa",
                "content": "• Destacado: Comunica conceptos moleculares complejos de manera simple, utiliza el lenguaje técnico con fluidez y responde con solvencia las preguntas del panel evaluador."
              }
            ]
          }
        }
