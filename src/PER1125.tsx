...
const course: Course = {
  ...
  "dimensions": [
    ...
    {
      "id": 2,
      "proposito": "Traduce el macro-perfil de egreso a nuestra cancha específica. Define el 'saber actuar' particular que esperamos desarrollar durante este semestre frente a la coyuntura política y comunicacional.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
    ...
    {
      "id": 3,
      "proposito": "Son nuestras metas evaluables a corto y mediano plazo. Hacen que la competencia general de la asignatura sea observable, medible y alcanzable hito a hito.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      ...
      "examples": [
        {
          ...
          "modalContent": {
            "title": "Estructura de Rúbrica: Ensayo Político",
            "subtitle": "Evalúa grados de calidad en la síntesis y reflexión crítica.",
            "items": [
              {
                "label": "Análisis y Argumentación",
                "content": "• Destacado: Desarrolla una tesis clara sostenida por argumentos profundos y referentes teóricos del curso.\n• Básico: Resumen descriptivo de los textos sin postura crítica."
              },
              {
                "label": "Integración de Corrientes",
                "content": "• Destacado: Relaciona coherentemente ideologías teóricas con la coyuntura política actual (ej. Chile o Latam).\n• Básico: Menciona conceptos aislados sin conexión con el presente."
              },
              {
                "label": "Redacción Periodística",
                "content": "• Destacado: Estructura fluida, argumentación persuasiva, sin errores de formato y con uso normativo de citas."
              }
            ]
          }
        },
        ...
        },
        {
          ...
          "modalContent": {
            "title": "Estructura de Rúbrica: Presentación Oral",
            "subtitle": "Evaluación conjunta de forma (expresión) y fondo (disciplina).",
            "items": [
              {
                "label": "Solidez del Mensaje (Fondo)",
                "content": "• Destacado: Explica las corrientes políticas con precisión, diferenciando matices entre autores."
              },
              {
                "label": "Habilidad Comunicativa (Forma)",
                "content": "• Destacado: Mantiene atención de la audiencia, tono persuasivo, contacto visual y no lee de sus apuntes."
              },
              {
                "label": "Uso de Evidencia y Medios",
                "content": "• Destacado: Integra recursos audiovisuales (ej. noticias, clips) que realmente sustentan y ejemplifican su argumento."
              }
            ]
          }
        }
