...
const course: Course = {
  ...
  "dimensions": [
    ...
    {
      "id": 2,
      "proposito": "Delimita el 'saber actuar' esperado al final del curso. Nos obliga a evaluar la movilización integrada de conocimientos, habilidades y actitudes frente a una situación desafiante, y no solo la memorización de contenidos desconectados.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
    ...
    {
      "id": 3,
      "proposito": "Son nuestras 'metas volantes'. Operacionalizan la competencia general en desempeños observables, medibles y alcanzables que podemos monitorear semana a semana durante el semestre.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      ...
      "examples": [
        {
          ...
          "modalContent": {
            ...
            "items": [
              {
                "label": "Pronunciación e Inteligibilidad",
                "content": "• Destacado: Clara y comprensible sin esfuerzo por parte del oyente.\n• Adecuado: Comprensible, con acento materno marcado pero que no interfiere.\n• Básico: Errores frecuentes que obligan a pausas o dificultan la decodificación."
              },
              {
                "label": "Adecuación Pragmática",
                "content": "• Destacado: Responde al turno de habla y usa fórmulas de cortesía atingentes.\n• Básico: Respuestas inconexas o silencios prolongados que quiebran la comunicación."
              }
            ]
          }
        },
