...
const course: Course = {
  ...
  "dimensions": [
    ...
    {
      "id": 2,
      "proposito": "¿Qué sabrán hacer al terminar el semestre? La competencia es nuestro puente entre la teoría dura y la práctica musical. Sirve para asegurar que los conceptos de acústica no queden en el papel, sino que se vivencien.",
    ...
    {
      "id": 3,
      "proposito": "¿Cómo evidenciamos el avance paso a paso? Los resultados (RA) son nuestras metas a corto plazo. Nos dictan exactamente qué hitos deben cumplir los estudiantes antes de pasar a la siguiente unidad.",
      ...
      "examples": [
        {
          ...
          "modalContent": {
            ...
            "subtitle": "Enfocada en evaluar cómo el estudiante conecta la teoría acústica con la demostración in situ.",
            "items": [
              {
                "label": "Análisis Acústico de la Producción Sonora",
                "content": "• Destacado: Explica la mecánica de producción sonora vinculando parámetros físicos de forma impecable.\n• Adecuado: Explica la producción, pero con descripciones algo genéricas o imprecisiones menores.\n• Básico: Descripción superficial sin sustento acústico real."
              },
              {
                "label": "Uso Práctico de Materiales Sonoros",
                "content": "• Destacado: Integra y sincroniza demostraciones prácticas efectivas con instrumentos reales durante su explicación.\n• Básico: Ausencia total de demostración práctica o ejecución completamente desconectada de la teoría expuesta."
              },
              {
                "label": "Rigor en el Lenguaje Técnico",
                "content": "• Destacado: Discurso fluido usando sistemáticamente vocabulario disciplinar (timbre, espectro, armónicos).\n• Básico: Vocabulario predominantemente coloquial con errores conceptuales evidentes."
              }
            ]
          }
        },
