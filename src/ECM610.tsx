...
const course: Course = {
  ...
  "dimensions": [
    ...
    {
      "id": 2,
      "proposito": "¿Qué capacidades movilizaremos? Integramos ciencias básicas (hormonas, anatomía) con ecología profunda y toma de decisiones sostenibles.",
    ...
    {
      "id": 3,
      "proposito": "¿Cómo evidenciamos el progreso? Avanzamos desde la comprensión micro (hormonas) hacia la evaluación macro (estrategias evolutivas y planes de conservación).",
      ...
      "examples": [
        ...
        },
        {
          ...
          "modalContent": {
            ...
            "items": [
              {
                "label": "1. Fundamentación Biológica y Ecológica",
                "content": "• Destacado: Identifica impecablemente áreas críticas de desove y la estrategia reproductiva de la especie, sustentado con bibliografía científica actualizada.\n• Básico: Nombra la estrategia reproductiva pero omite variables críticas del hábitat de desarrollo larval."
              },
              {
                "label": "2. Diseño del Plan de Conservación (Viabilidad)",
                "content": "• Destacado: Las acciones propuestas (ej. Áreas Marinas Protegidas) son concretas, consideran el factor de impacto humano/cambio climático y se alinean a la normativa.\n• Básico: Propone medidas genéricas sin un cronograma claro o sin identificar a los actores sociales/gubernamentales involucrados."
              },
              {
                "label": "3. Calidad de la Exposición Oral y Defensa",
                "content": "• Destacado: Expone con fluidez, usa correctamente el lenguaje oceanográfico y defiende sólidamente las preguntas del panel."
              }
            ]
          }
        },
