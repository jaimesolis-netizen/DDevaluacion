...
const course: Course = {
  ...
  "dimensions": [
    ...
    {
      "id": 2,
      "proposito": "Funciona como un 'filtro curricular' personal. Le ayuda a discriminar rápidamente entre lo que es absolutamente esencial que el estudiante demuestre (gestionar y optimizar biológico/económicamente) y lo que es contenido secundario, enfocando sus esfuerzos evaluativos donde realmente importa.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
    ...
    {
      "id": 3,
      "proposito": "Fraccionan la macro-competencia del curso en hitos medibles a lo largo de las 14 semanas. El verbo de cada RA (ya sea 'explicar conceptos' o 'proponer soluciones') le indica de forma directa qué nivel de exigencia y qué formato debe tener su evaluación.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      ...
      "examples": [
        {
          ...
          "modalContent": {
            ...
            "subtitle": "Focaliza la atención en dimensiones críticas de aprendizaje complejo.",
            "items": [
              {
                "label": "Análisis del Entorno Sectorial",
                "content": "• Destacado: Articula un diagnóstico PESTEL exhaustivo, fundamentando oportunidades reales en el sector agrícola actual.\n• Básico: Diagnóstico genérico que no utiliza fuentes de datos ni evidencia del rubro agropecuario."
              },
              {
                "label": "Viabilidad y Proyección Financiera",
                "content": "• Destacado: Flujo de caja coherente, VAN/TIR calculados con correcta justificación técnica de la tasa de descuento.\n• Básico: Omite costos operativos claves del agro; los errores de cálculo invalidan la propuesta."
              }
            ]
          }
        },
