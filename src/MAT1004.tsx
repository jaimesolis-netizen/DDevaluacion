...
const course: Course = {
  ...
  "dimensions": [
    ...
    {
      "id": 2,
      "proposito": "¿Qué sabrán hacer al terminar el semestre? La competencia central es el puente entre el álgebra abstracta pura y su aplicación pragmática en la ingeniería.",
    ...
    {
      "id": 3,
      "proposito": "¿Cómo evidenciamos el avance paso a paso? Los resultados son las metas concretas que nos indican si el estudiante logra resolver, abstraer e interpretar los fenómenos matemáticos.",
      ...
      "examples": [
        ...
        },
        {
          ...
          "modalContent": {
            ...
            "items": [
              {
                "label": "1. Abstracción del Modelo a Sistema Lineal",
                "content": "• Destacado: Transforma impecablemente el enunciado ingenieril en un sistema matricial identificando variables.\n• Básico: Logra un sistema, pero omite variables relevantes o plantea ecuaciones redundantes."
              },
              {
                "label": "2. Rigor en el Cálculo y Resolución",
                "content": "• Destacado: Aplica métodos (ej. Gauss-Jordan o Laplace) sin errores algebraicos, llegando al conjunto solución correcto.\n• Básico: Presenta errores operativos mayores que alteran completamente la solución final."
              },
              {
                "label": "3. Interpretación de la Solución",
                "content": "• Destacado: Verifica las restricciones del sistema e interpreta qué significa el resultado en el contexto del problema original."
              }
            ]
          }
        },
