...
const course: Course = {
  ...
  "dimensions": [
    ...
    {
      "id": 2,
      "proposito": "¿Qué capacidades movilizaremos? Integramos la lectura del espacio geográfico urbano con herramientas técnicas de planificación local y evaluación rigurosa de riesgos.",
    ...
    {
      "id": 3,
      "proposito": "¿Cómo evidenciamos el progreso? Desde la observación morfológica básica hasta el diseño complejo de planes de zonificación y análisis de manifestaciones socioculturales urbanas.",
      ...
      "examples": [
        ...
        },
        {
          ...
          "modalContent": {
            ...
            "items": [
              {
                "label": "1. Diagnóstico de la Unidad Territorial",
                "content": "• Destacado: Justifica sólidamente la elección de la unidad crítica (ej. asentamiento precario, zona patrimonial), apoyándose en datos espaciales y socioeconómicos relevantes.\n• Básico: Describe el lugar de forma genérica sin aportar datos que evidencien su criticidad territorial."
              },
              {
                "label": "2. Diseño de Metodología de Riesgos",
                "content": "• Destacado: Construye una secuencia metodológica lógica y fundamentada para evaluar al menos una amenaza (inundación, remoción, incendio), cruzando variables de exposición y vulnerabilidad.\n• Básico: Enumera amenazas pero no establece un método paso a paso que permita objetivar o espacializar el nivel de riesgo."
              },
              {
                "label": "3. Propuesta de Zonificación",
                "content": "• Destacado: Establece áreas de zonificación que consideran lógicas de capacidad de carga, proponiendo usos de suelo coherentes para mitigar la amenaza detectada."
              }
            ]
          }
        }
